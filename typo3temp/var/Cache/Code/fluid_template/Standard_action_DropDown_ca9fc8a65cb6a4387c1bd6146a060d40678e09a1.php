...
class Standard_action_DropDown_ca9fc8a65cb6a4387c1bd6146a060d40678e09a1 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output76 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('openDocument.onClickCode', $array81), ENT_QUOTES);
...
$output76 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('openDocument.label', $array82), ENT_QUOTES);
...
$output76 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('openDocument.md5sum', $array83), ENT_QUOTES);
...
$arguments84['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_core.xlf:rm.closeDoc';

$output76 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments84, $renderChildrenClosure85, $renderingContext), ENT_QUOTES);
...
$output93 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments94, $renderChildrenClosure95, $renderingContext), ENT_QUOTES);
...
$output99 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('recentDocument.onClickCode', $array104), ENT_QUOTES);
...
$output99 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('recentDocument.label', $array105), ENT_QUOTES);
...
$output8 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments9, $renderChildrenClosure10, $renderingContext), ENT_QUOTES);
...
$output17 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments18, $renderChildrenClosure19, $renderingContext), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('openDocument.onClickCode', $array28), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('openDocument.label', $array29), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('openDocument.md5sum', $array30), ENT_QUOTES);
...
$arguments31['key'] = 'LLL:EXT:lang/Resources/Private/Language/locallang_core.xlf:rm.closeDoc';

$output23 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments31, $renderChildrenClosure32, $renderingContext), ENT_QUOTES);
...
$output40 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments41, $renderChildrenClosure42, $renderingContext), ENT_QUOTES);
...
$output46 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('recentDocument.onClickCode', $array51), ENT_QUOTES);
...
$output46 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('recentDocument.label', $array52), ENT_QUOTES);
